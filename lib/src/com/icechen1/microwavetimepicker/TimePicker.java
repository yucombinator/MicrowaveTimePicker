...
public class TimePicker extends TimerSetupView implements Button.OnClickListener{
    ...
    public TimePicker(Context context, AttributeSet attrs) {
        ...
        try {
        	mIs24HoursMode = a.getBoolean(R.styleable.TimePicker_format_24, false);
        } finally {
            a.recycle();
        }
    ...
    /**
     * Creates a TimePicker object, and setting the 24 Hours mode setting.
     * @param context
     * @param Is24HoursMode true: 24 hours false: AM/PM
     */
    public TimePicker(Context context, boolean arg) {
        super(context,null);
        mInputSize = 4;
        mNoAmPmLabel = context.getResources().getString(R.string.time_picker_ampm_label);
        mIs24HoursMode = arg;
